...
- Drag the labeled player seats into snapping triangle, square, and other regular table positions before the first deal; the locked clockwise order controls turns for the entire game.
