...
- Set up two to eight players, player names, starting chips, dealer, small blind, optional double-sized big blind, No Limit/Pot Limit/Fixed Limit betting, and the scheduled blind increase.
