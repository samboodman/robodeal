...
- Drag the labeled player seats into snapping regular table positions before the first deal. Every player count also includes the four common square angles, and the locked clockwise order controls turns for the entire game.
